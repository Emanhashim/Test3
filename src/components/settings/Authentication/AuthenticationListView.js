...
if (loading){
  ...
  return (
    ...
    <div className="container">
            ...
            <div class="ribbon ribbon-top-right"><span>Authentication</span></div>
    ...
    {modalOpen && <AuthenticationType setOpenModal={setModalOpen} />}
      <div className="py-2"> 
...
export default AuthenticationListView;