...
import BankListView from './AuthenticationListView';
import CornerRibbon from "react-corner-ribbon";
import {RiMoneyDollarCircleLine, RiBankLine } from "react-icons/ri";
export default function AuthenticationType({ setOpenModal }) {
 ...
 <div class="ribbonBank ribbon-top-leftBank"><span style={{fontSize:"10px" }}>Authentication type</span></div>
 <SiAuth0 style={{ color: "#ffc107", fontSize: "15px" ,position: "2px" }}/>
                <label>Type</label>    
 <div className='fresh-field-wrapper'>

<input type="text" className= "Sfresh-inputBank " placeholder='Enter Authentication Type' value={name}
 {...register("bank", { required: { value: true, message: "Please Enter Authentication Type", }, maxLength: { value: 50, message: " maximum  50 characters" }, minLength: { value: 5, message: " must have at least 5 characters" },
 ...
 <div className='fresh-field-wrapper'>
<input type="text" className= "fresh-input-textareaAuth " placeholder='' value={description}
